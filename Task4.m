...
wings_twist = struct('AR', AR, 'b', b, 'alpha_g0', alpha_g0, ...
...
Gamma_nd = Gamma./(U_0*wing.c_root);

wings_twist.LL_res = struct('y', y, 'theta', theta, 'A', A, ...
                             'alpha_g', alpha_g,...
                             'alpha_i', alpha_i, 'C_l', C_l, ...
                             'C_di', C_di,  ...
                             'Gamma', Gamma, 'Gamma_nd', Gamma_nd);

save(fullfile(res_fld, 'T4_wings_rect_twist.mat'), 'wings_twist');
